...
import { deployWardenYield, upgradeAaveYieldToV2 } from '../deploy/src';
...
task('task:upgrade-AaveYield-to-v2', 'Upgrade AaeYield from v1 to v2')
  .addParam<string>('networkName', 'Network name')
  .addParam<string>('proxyAddress', 'Address of the AaeYield proxy')
  .addParam<string>('newImplementationAddress', 'Address of the new AaveYield implementation')
  .addParam<string>('token', 'usdc or usdt')
